   ...
   long long int f( int i, int j,int maxMove,int m, int n,vector<vector<vector<long long int>>>&dp)
    {
       ...
       long long int a=f(i-1,j,maxMove-1,m,n,dp)%mx;
       long long int b=f(i+1,j,maxMove-1,m,n,dp)%mx;
        long long int c=f(i,j+1,maxMove-1,m,n,dp)%mx;
        long long int d=f(i,j-1,maxMove-1,m,n,dp)%mx;
